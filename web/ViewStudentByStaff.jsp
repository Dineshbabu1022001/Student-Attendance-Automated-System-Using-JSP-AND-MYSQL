                    ...
                    <div class="mainbar">
                        <div class="article">
                            ...
                            <table border="1" align="center" cellpadding="5" cellspacing="0" width="85%" rules="rows">
                                <tr>
                                    <td colspan="8" style="font-size: x-large; font-weight: bold;text-align: center;color: white;background-color: hotpink;letter-spacing: 5px;">View Student Details by Staff</td>
                                </tr>
