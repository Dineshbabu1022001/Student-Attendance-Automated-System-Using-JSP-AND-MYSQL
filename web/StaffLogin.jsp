                ...
                <div class="content_resize">
                    <div class="mainbar">
                        <div class="article">
                            ...
                            <form name="form1" method="post" action="StaffLogin.jsp">
                                <table border="0" align="center" cellpadding="5" cellspacing="6">
                                    ...
                                    <tr>
                                        <td style="color: deepskyblue;font-weight:bold; font-size: large">Staff Id</td>
                            ...
                            <%
                                if (request.getParameter("s1") != null) {
                                    ...
                                    if (rs.next()) {
                                        ...
                                        response.sendRedirect("MyDetails_Staff.jsp");
                                    } else {
