                ...
                <div class="content_resize">
                    <div class="mainbar">
                        <div class="article">
                            ...
                            <form name="form1" method="post" action="StudentLogin.jsp">
                                <table border="0" align="center" cellpadding="5" cellspacing="6">
                                    ...
                                    <tr>
                                        <td style="color: deepskyblue;font-weight:bold; font-size: large">Student Register No</td>
                            ...
                            <%                                if (request.getParameter("s1") != null) {
                                    ps = con.prepareStatement("select * from Students where registerno=? and password=?");
                                    ps.setString(1, request.getParameter("t1"));
                                    ps.setString(2, request.getParameter("t2"));
                                    rs = ps.executeQuery();
                                    if (rs.next()) {
                                        session.setAttribute("RegisterNo", request.getParameter("t1"));
                                        session.setAttribute("Degree", rs.getString(10));
                                        session.setAttribute("StudyingYear", rs.getString(11));
                                        response.sendRedirect("MyDetails_Student.jsp");
                                    } else {
