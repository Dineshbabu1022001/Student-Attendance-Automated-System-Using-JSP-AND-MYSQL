                    ...
                    <div class="mainbar">
                        <div class="article">
                            ...
                            <%!        
                                ResultSet rs;
                            %>
                            <table border="1" align="center" cellpadding="10" cellspacing="0" width="85%" rules="rows">
                                <tr>
                                ...
                                <%
                                    ps = con.prepareStatement("select * from Staffs where dept=?");
                                    ps.setString(1, session.getAttribute("Degree").toString());
                                    //ps.setString(2, session.getAttribute("StudyingYear").toString());
                                    rs = ps.executeQuery();
                                    while (rs.next()) {
                                %>
