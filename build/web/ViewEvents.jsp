                    ...
                    <div class="mainbar">
                        <div class="article">
                            ...
                            <table border="1" align="center" cellpadding="5" cellspacing="0" width="85%" rules="rows">
                                <tr>
                                    <td colspan="6" style="font-size: x-large; font-weight: bold;text-align: center;color: white;background-color: forestgreen;letter-spacing: 5px;">View Events Details by Admin</td>
                                </tr>
                                ...
                                <%
                                    ps = con.prepareStatement("select * from Events order by eventdate desc");
                                    rs = ps.executeQuery();
                                    while (rs.next()) {
                                %>
